...
public class ViewGame extends JFrame{ 
    ...
    public ViewGame(Matrice matrice, Graphe view, String nom){
        this.nom = nom;
        ...
        setTitle("Chemins Eulériens - Jeu");
        setSize(800,600);
        add(panneauBoutton);
        ...
        valider.addActionListener(e ->{
            ...
            if(valider.getText().equals("Suivant")) {
            	...
            	compteur=0;
            	panneauGraphe = new Graphe(CheminEuler.MatriceAleaEuler());
                panneauGraphe.setBackground(new Color(219,219,219));
        		...
        		final ArrayList<Integer> reponse_ordinateur = CheminEuler.cheminEuler(panneauGraphe.getMatrice().copie());
            	...
            	if(reponse_joueur.containsAll(reponse_ordinateur) && matriceorigine.Si1()==false) {
                    ...
                    gagne.setText("Bravo " + nom + ", Vous avez reussi le niveau. \n"
                                    ...
                                    + "rendez vous dans le fichier \"score\" pour voir tous vos resultats. " );
        ...
        solutionComplete.addActionListener((ActionEvent e)->{   
            indice.setText("");   
            panneauGraphe.add(new JLabel("la réponse qui était attendu : " + Arrays.toString(CheminEuler.cheminEuler(panneauGraphe.getMatOri().copie()).toArray()) + " au suivant"));
            valider.setText("Suivant");
            solutionPartielle.setEnabled(false);
            solutionComplete.setEnabled(false);
            panneauGraphe.setPlayingFalse();
